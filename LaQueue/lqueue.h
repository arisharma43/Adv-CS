...
struct lq_attr {
  ...
  long lq_maxmsg;   /* maximum number of messages -- not used in current implementation -- must change */
  long lq_msgsize;  /* maximum message size -- not used in current implementation -- must change */
